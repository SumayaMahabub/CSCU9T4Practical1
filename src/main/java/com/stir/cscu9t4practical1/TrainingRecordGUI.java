...
public class TrainingRecordGUI extends JFrame implements ActionListener {
    ...
    private JComboBox<String> entries = new JComboBox<>(new String[]{"Run/Sprints", "Cycle", "Swim"});
    ...
    public void actionPerformed(ActionEvent event) {
        ...
        {
            if(entries.getSelectedItem().equals("Run/Sprints"))
            {
                swimPanel.setVisible(false);
                cyclePanel.setVisible(false);
                sprintPanel.setVisible(true);
            }
            else if (entries.getSelectedItem().equals("Cycle"))
            {
            ...
            else if (entries.getSelectedItem().equals("Swim"))
            {
                sprintPanel.setVisible(false);
                cyclePanel.setVisible(false);
    ...
    public String addEntry(String what) {
        ...
        if(name.getText().isBlank()) {
            ...
            try {
                ...
                if(entries.getSelectedItem().equals("Sprint"))
                {
